...
A short and simple python based Twitter bot created by myself and [anshul-rao](https://github.com/ShivPatel123) using the [Tweepy](https://github.com/tweepy/tweepy) library. This bot will automatically enter giveaways by liking, commenting, retweeting, and following the author of the post. 
